...
def api():
	rr = random.randint
	rc = random.choice
	return f"Mozilla/5.0 (Linux; Android 13; SM-A035G Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/132.0.6834.163 Mobile Safari/537.36"
def ugen():
  rr = random.randint
  rc = random.choice
  androversi = random.choice(["15_4","14_3","13_5","14_5","13_4"])
  asep1 = random.choice(["Y6MLQN","8G7LN3","2783VM","X35XFL","W5T30Y"])
  asep4 = f"Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/104.0.0.0 Safari/537.36"
  return rc([asep4])
...
def _validate_(uid,pasw):
    ...
    'dpr': '2.75',
    'referer': 'https://m.prod.facebook.com/bookmarks/',
